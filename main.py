                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p>10 users included, 2 GB of storage, Email support, Help center access</p>
                        ...
                        <div style="min-height: 120px;">
                            ...
                            >
                                <div class="card card-body"
                                     style="width: 300px;"
                                >
                                    Для покупки воспользуйтесь кнопкой Купить.
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="min-height: 120px;">
                            ...
                            >
                                <div class="card card-body"
                                     style="width: 300px;"
                                >
                                    Чтобы доставить товар перейдите в соответствующий раздел на сайте.
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="min-height: 120px;">
                            ...
                            >
                                <div class="card card-body"
                                     style="width: 300px;"
                                >
                                    Гарантийные обязательства указаны в лицензионном соглашении.
                                </div>
                            </div>
                        </div>
                    </div>
